                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo base_url();?>apanel/studentAttendance">Student Attendance</a></li>
                                <li><a href="<?php echo base_url();?>apanel/studentAttenReport">Student Attendance Report</a></li>
